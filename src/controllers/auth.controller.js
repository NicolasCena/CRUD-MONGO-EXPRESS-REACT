...
export const register = async (req, res) => {
    try {
        ...
        const token = await createAccessToken({ id: savedNewUser._id });
...
export const login = async (req, res) => {
    try {
        ...
        // userFound es el objeto del usuario encontrado. Sino es un objeto error
        ...
        if(!passMatch) return res.status(400).send({ message: "Incorrect password"});
